...
EXECUTABLE=${EXECUTABLE:-"$BUILD_DIR/CHATProcessor/Main/CHATProcessor"}
...
print_logo() {
    ...
    echo -e "${CYAN}------------------------------------------------------------${RESET}"
    echo -e "${BOLD}${RED}   ____ _   _    _    _____ ${RESET}"
    echo -e "${BOLD}${GREEN}  / ___| | | |  / \\  |_   _|${RESET}"
    echo -e "${BOLD}${YELLOW} | |   | |_| | / _ \\   | |  ${RESET}"
    echo -e "${BOLD}${BLUE} | |___|  _  |/ ___ \\  | |  ${RESET}"
    echo -e "${BOLD}${MAGENTA}  \\____|_| |_/_/   \\_\\ |_|  ${RESET}"
    echo -e "${CYAN}------------------------------------------------------------${RESET}"
    echo -e "${BOLD}${CYAN}           Run CHAT ${VERSION}${RESET}"
    echo -e "${CYAN}------------------------------------------------------------${RESET}"
}
